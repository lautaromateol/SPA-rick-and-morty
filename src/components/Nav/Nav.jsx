...
export default function Nav() {
   ...
   return (
      ...
      <nav className="w-full p-3 border border-solid border-1 border-[rgba(195,219,67,255)] bg-[rgba(64,180,202,255)]">
         ...
         <Link className="m-1 font-bold py-2 px-4 bg-[rgba(64,180,202,255)] hover:bg-blue-400 text-[rgba(195,219,67,255)] border border-[rgba(195,219,67,255)] rounded-full" to="/about"><FontAwesomeIcon icon={faUser} flip="horizontal" size="sm" /></Link>
